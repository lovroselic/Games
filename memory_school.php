...
<html>
    <head>
        ...
        <title>MEMORY - SCHOOL</title>
        <?php include_once '../Include/IE_patch.php'; ?>
        <script src="memory_school.js" type="text/javascript"></script>
        <style>
    ...
    <body>
        ...
        <div class="win"> <a href="/Games/" title="Return to games' index">
            ...
            <p>Find the pairs; each picture has its matching word. The theme of this game is school and school accessories.</p>
