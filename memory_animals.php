...
<html>
    <head>
        ...
        <script src="memory_animals.js" type="text/javascript"></script>
        <style>
    ...
    <body>
        ...
        <div class="win"> <a href="/Games/" title="Return to games' index">
            ...
            <p>Find the pairs; each picture has its matching word. The theme of this game are animals.</p>
            ...
            <form action="">
                <input checked id="pronounce" name="Pronounce" type="checkbox" value="clickpronounce">Pronounce animals names.<br>
            </form>
