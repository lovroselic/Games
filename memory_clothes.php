...
<html>
    <head>
        ...
        <title>MEMORY - CLOTHES</title>
        <?php include_once '../Include/IE_patch.php'; ?>
        <script src="memory_clothes.js" type="text/javascript"></script>
        <style>
    ...
    <body>
        ...
        <div class="win"> <a href="/Games/" title="Return to games' index">
            ...
            <h1>Memory - Clothes</h1>

            <p>Find the pairs; each picture has its matching word. The theme of this game are clothes.</p>
            ...
            <form action="">
                <input checked id="pronounce" name="Pronounce" type="checkbox" value="clickpronounce">Pronounce clothes.<br>
            </form>
