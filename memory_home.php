...
<html>
    <head>
        ...
        <script src="memory_home.js" type="text/javascript"></script>
        <style>
    ...
    <body>
        ...
        <div class="win"> <a href="/Games/" title="Return to games' index">
            ...
            <h1>Memory - Home & Hobby</h1>

            <p>Find the pairs; each picture has its matching word. The theme of this game are home and hobby objects.</p>
            ...
            <form action="">
                <input checked id="pronounce" name="Pronounce" type="checkbox" value="clickpronounce">Pronounce names.<br>
            </form>
