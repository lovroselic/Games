...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/CSS/ordinals.css">
        <title>Memory - Ordinals</title>
        <?php include_once '../Include/IE_patch.php'; ?>
        <script type="text/javascript" src ="memory_ord.js"></script>
        <style>
    ...
    <body>
        ...
        <div class="win">
            ...
            <h1>Memory - Ordinals</h1>
            <p>Find the pairs; each ordinal has its matching word ('1st - FIRST', 'NINTH - 9th'). 
                This variant focuses on numbers 1-12.</p>
